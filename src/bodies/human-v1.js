  function Human (bodyThickness) {
    ...
    },
    {
      ...
      relativeTo: "backRightShoulder",
      position: [1.0,0, 0],
      bondTo: [{ strength: 1, name: "backRightShoulder" }],
      rigidGroup: "rightArm"
    },
    {
      ...
      relativeTo: "frontRightShoulder",
      position: [1.0,0, 0],
      bondTo: ["backRightArmHinge", { strength: 1, name: "frontRightShoulder"}],
      rigidGroup: "rightArm"
    },
    {
      ...
      relativeTo: "backRightShoulder",
      position: [1.0,-1,0],
      bondTo: ["backRightArmHinge",{ strength: 5.0, name: "backRightArmpit"},{ strength: 5.0, name: "backRightShoulder"}],
      rigidGroup: "rightArm"
    },
    {
      ...
      relativeTo: "frontRightShoulder",
      position: [1.0,-1,0],
      bondTo: ["frontRightArmHinge",{ strength: 5.0, name: "frontRightArmpit"},{strength: 5.0, name: "backRightShoulder"}],
      rigidGroup: "rightArm"
    },
    {
